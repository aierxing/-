package com.lei.设计模式.行为型模式.策略模式;
...
class SteamedCrabs extends JLabel implements CrabCooking {
    ...
    public void CookingMethod() {
        this.setIcon(new ImageIcon(this.getClass().getResource("/src/SteamedCrabs.jpg")));
...
class BraisedCrabs extends JLabel implements CrabCooking {
    ...
    public void CookingMethod() {
        this.setIcon(new ImageIcon(this.getClass().getResource("/src/BraisedCrabs.jpg")));
        this.setHorizontalAlignment(CENTER);
    }
}
